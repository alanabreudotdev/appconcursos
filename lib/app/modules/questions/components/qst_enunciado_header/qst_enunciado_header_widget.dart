...
class QstEnunciadoHeaderWidget extends StatelessWidget {

final String enunciadoTxt;

  var _controller = ExpandableController(initialExpanded: true);

  QstEnunciadoHeaderWidget({ this.enunciadoTxt = 'carregando'});
